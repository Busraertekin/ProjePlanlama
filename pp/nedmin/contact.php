          ...
          <form class="form-horizontal form-label-left" action="process.php" method="POST">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input class="form-control col-md-7 col-xs-12" name="contact_title" value="<?php echo $fetch['contact_title'] ?>" required="required" type="text">
              </div>
            </div>
            </br>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="tel" name="email" value="<?php echo $fetch['email'] ?>" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="gsm" value="<?php echo $fetch['gsm'] ?>" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            </br>
            <div class="item form-group">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="copyright" value="<?php echo $fetch['copyright'] ?>" required="required" class="form-control col-md-7 col-xs-12">
              </div>
