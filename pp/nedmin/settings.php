    ...
    <?php } ?>
          ...
          <form class="form-horizontal form-label-left" action="process.php" method="POST">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="title" value="<?php echo $fetch['title'] ?>" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">Alt Başlık
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="subtitle" value="<?php echo $fetch['subtitle'] ?>" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="item form-group">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="password" name="newpassword" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="item form-group">
            ...
            <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">Profil fotoğrafı
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="file" name="picture" value="<?php echo $fetch['picture'] ?>" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
